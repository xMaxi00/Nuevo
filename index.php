        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body"> <!--Cuerpo del Formulario modal-->
                    ...
                    <input type="text" class="form-control" name="runagregar" id="runagregar" pattern="[0-9-]{10,}" required /><!--Espacio para ingresar texto-->
                    <span id="rutError" class="error"></span>
                    <div id="msg"></div>
                    <br>
                    <p>Ingrese Nombre</p> <!-- Linea de Texto que solicita el Nombre a agregar-->
                    <input type="text" class="form-control" name="nombagregar" id="nombagregar" pattern="[A-Za-zÁÉÍÓÚáéíóúÑñ\s]+" title="El nombre ingresado tiene caracteres inválidos, por favor ingrese solo letras" maxlength="100" /> <!--Espacio para ingresar texto-->
                    <!-- Se utiliza codigo de validación pattern de Bootstrap -->
                    <br>
                    <p>Ingrese Fono</p> <!-- Linea de Texto que solicita el fono  agregar-->
                    <input type="text" class="form-control" name="fonoagregar" id="fonoagregar" pattern="[0-9]+" title="Por favor, ingrese solo números" maxlength="11" minlength="11" /> <!--Espacio para ingresar texto-->
                    <!-- Se utiliza codigo de validación pattern de Bootstrap -->
                    <br>
                ...
                <div class="modal-footer"> <!-- Botones de Cancelar y Guardar con sus caracteristicas -->
                    ...
                    <button type="submit" class="btn btn-dark">Guardar</button> <!-- Ejecuta el archivo validar cuando se presiona -->
                    <!--Funcion para validar rut, cumple condiciones de largo y real -->
                    <script>
                        function validarRut(rut) 
                        {
                            ...
                            const dvActual = dv.toLowerCase() === 'k' ? 10 : parseInt(dv);

                            return dvEsperado === dvActual || (dvEsperado === 11 && dvActual === 0);

                        }

                        document.getElementById('modalagregar').addEventListener('submit', function(event) 
                        {

                            const rutInput = document.getElementById('runagregar');
                            ...
                            {
                                event.preventDefault();
                                alert('El número ingresado debe tener al menos 10 caracteres.');
                            }
                        });
                    </script>
                </div>
